...
# datetime:3/24/2023 11:30 AM

"""
==================

Module for tides calculations functions (solid-earth tide).
------------------------------------------------------------------------
...
def ocean_loading(time, amp, phases, lon):
    ...
    # Calculate the mean longitudes of the sun (h0), moon (s0) and lunar perigee (p0).
